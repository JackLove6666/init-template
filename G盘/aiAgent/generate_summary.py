...
CATEGORY_RULES: list[tuple[str, list[str]]] = [
    ...
    ("网络 / 通信 / 隐私", ["chat", "privacy", "quic", "nat", "messaging", "iroh", "simplex", "隐私", "tailscale", "headscale", "ntfy", "cryptomator", "rustdesk", "frp", "canopy", "stalwart", "schollz/croc", "croc", "bitchat", "netbird", "wireguard", "temp_email", "temp email", "vaultwarden", "bitwarden", "httpsms", "sms"]),
