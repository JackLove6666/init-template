...
CATEGORY_RULES: list[tuple[str, list[str]]] = [
    ...
    ("视频 / 多媒体 / 会议", ["video", "meeting", "iptv", "transcri", "montage", "media", "会议", "直播", "opencut", "voicebox", "romm", "smarttube", "immich", "claude-video", "peertube", "webtorrent", "openwhispr", "bevy", "lingbot-map", "palmier", "video-use", "jellium", "jellyfin", "pocket-tts", "tts", "screenpipe", "blender"]),
    ...
    ("数据库 / 存储", ["database", "vector", "storage", "zvec", "sql", "向量库", "turso", "dbx", "elasticsearch", "qdrant", "chat2db", "pocketbase", "prisma", "orm"]),
