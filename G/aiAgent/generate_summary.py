...
PLAIN_MAP: dict[str, str] = {
    ...
    "Shubhamsaboo/awesome-llm-apps": "100+ 可直接跑的 AI Agent/RAG 应用合集：克隆、改改就能上线",
    "Nutlope/hallmark": "反「AI 味」设计技能：给 Claude Code/Cursor/Codex 用",
    "canopy-network/canopy": "Canopy 网络协议的官方 Go 实现",
    "vxcontrol/pentagi": "全自动 AI 渗透测试智能体系统，能独立完成复杂安全任务",
    "ibelick/ui-skills": "给设计工程师用的 AI Skills 技能包",
    "FB208/OpenBidKit_Yibiao": "开箱即用的 AI 标书工具：生成、知识库、查重、废标项检查",
    "stalwartlabs/stalwart": "一体化邮件与协作服务器：IMAP/JMAP/SMTP/日历通讯录全包",
}
...
CATEGORY_RULES: list[tuple[str, list[str]]] = [
    ...
    ("知识库 / RAG / 记忆", ["memory", "rag", "knowledge", "记忆", "cognee", "ragflow", "weknora", "open-notebook", "hyper-extract"]),
    ...
    ("视频 / 多媒体 / 会议", ["video", "meeting", "iptv", "transcri", "montage", "media", "会议", "直播", "opencut", "voicebox", "romm", "smarttube", "immich", "claude-video", "peertube", "webtorrent", "openwhispr", "bevy", "lingbot-map"]),
    ("网络 / 通信 / 隐私", ["chat", "privacy", "quic", "nat", "messaging", "iroh", "simplex", "隐私", "tailscale", "headscale", "ntfy", "cryptomator", "rustdesk", "frp", "stalwart", "canopy"]),
    ...
    ("前端 / Web / UI", ["ui", "frontend", "web", "css", "react", "vue", "imgui", "page-agent", "taste", "impeccable", "fastify", "express", "swc", "biome", "insomnia", "open-seo", "hallmark", "ui-skills"]),
    ("移动 / 跨端", ["android", "ios", "mobile", "flutter", "react-native", "跨端", "smarttube"]),
    ("大模型 / LLM 基础设施", ["llm", "prompt", "gateway", "token", "model", "openai", "claude", "gpt", "gemini", "inference", "omniroute", "lmcache", "timesfm", "slime", "skillopt", "system_prompts", "grok2api", "caveman", "awesome-llm-apps"]),
    ("AI 编程助手 / 开发工具", ["coding", "code", "ide", "copilot", "cursor", "developer", "mcp", "cli", "devtools", "codex", "ripgrep", "fzf", "helix", "deno", "jadx", "archify", "no-mistakes", "desktopcommander", "chrome-devtools", "stitch-skills", "plugins", "officecli", "destructive_command", "sharkdp/bat", "wezterm", "openbidkit", "yibiao"]),
