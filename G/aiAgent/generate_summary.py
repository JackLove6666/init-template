...
PLAIN_MAP: dict[str, str] = {
    ...
    "facebook/astryx": "Meta 开源可深度定制的设计系统，专为 AI Agent 协作而生",
    "alirezarezvani/claude-skills": "超大 Claude/多 Agent 技能合集：工程、营销、产品、合规到日常效率",
    "1jehuang/jcode": "更聪明的代码 Agent 运行框架（harness），专治复杂编程任务",
    "earthtojake/text-to-cad": "给 CAD/机器人/硬件设计用的 Agent 技能包：文本驱动建模",
    "kyutai-labs/pocket-tts": "能塞进 CPU（和口袋）的轻量语音合成 TTS",
    "google/agents-cli": "谷歌 CLI+技能：让任意编程助手精通在 GCP 上创建/评估/部署 Agent",
    "Mintplex-Labs/anything-llm": "本地优先全能 AI 知识库/Agent：文档、聊天、工具都自己掌控",
    "agegr/pi-web": "pi 编程 Agent 的网页界面，浏览器里就能用",
    "sveltejs/svelte": "少写样板代码的前端框架：编译期优化，面向普通人友好",
}
...
CATEGORY_RULES: list[tuple[str, list[str]]] = [
    ...
    ("知识库 / RAG / 记忆", ["memory", "rag", "knowledge", "记忆", "cognee", "ragflow", "weknora", "open-notebook", "hyper-extract", "compendium", "graphify", "anything-llm"]),
    ...
    ("视频 / 多媒体 / 会议", ["video", "meeting", "iptv", "transcri", "montage", "media", "会议", "直播", "opencut", "voicebox", "romm", "smarttube", "immich", "claude-video", "peertube", "webtorrent", "openwhispr", "bevy", "lingbot-map", "palmier", "video-use", "pocket-tts", "tts"]),
    ...
    ("前端 / Web / UI", ["ui", "frontend", "web", "css", "react", "vue", "imgui", "page-agent", "taste", "impeccable", "fastify", "express", "swc", "biome", "insomnia", "open-seo", "hallmark", "ui-skills", "design.md", "infinite-canvas", "shadcn", "astryx", "svelte"]),
